...
const SocialProofLogos: React.FC<{ align?: 'center' | 'left' }> = ({ align = 'center' }) => {
    const icons = [
    ...
    return (
        <div className={`mt-12 ${align === 'left' ? 'text-left' : 'text-center'}`}>
            <p className={`text-sm text-gray-500 font-medium mb-6 ${align === 'left' ? '' : 'mx-auto'}`}>USED BY PROFESSIONALS AT:</p>
            <div className={`flex items-center space-x-6 sm:space-x-8 md:space-x-12 opacity-60 grayscale flex-wrap ${align === 'left' ? 'justify-start' : 'justify-center'}`}>
                {icons.map(({ Icon, name }) => (
                    ...
                    <section className="min-h-screen flex items-center pt-24 pb-16 relative overflow-hidden">
                        <div className="container mx-auto px-4 grid lg:grid-cols-2 gap-12 items-center relative z-10">
                            ...
                            <div className="text-center lg:text-left z-20">
                                ...
                                <p className="text-base sm:text-lg md:text-xl text-gray-400 mb-8 animate-fade-in-up delay-100 max-w-2xl mx-auto lg:mx-0">
                                    SAHA AI automatically qualifies leads, handles replies and follow-ups, and updates your CRM without any manual work.
                                </p>
                                <div className="flex flex-col sm:flex-row items-center justify-center lg:justify-start space-y-4 sm:space-y-0 sm:space-x-4 animate-fade-in-up delay-200 mb-12">
                                ...
                                <div className="animate-fade-in-up delay-300">
                                    <SocialProofLogos align="left" />
                                </div>
                            </div>

                            {/* 3D Scene - Visible on large screens */}
